...
insert into [dbo].[ListaZaNarudzbe]
		...
		VALUES
					('20', (select ArtikalId from [dbo].[Artikal] where ArtikalIme='Coca Cola'), (select NarudzbaZaKaficId from [dbo].NarudzbaZaKafic where StatusNarudzbe='0')),
					('10', (select ArtikalId from [dbo].[Artikal] where ArtikalIme='Pipi'), (select NarudzbaZaKaficId from [dbo].NarudzbaZaKafic where StatusNarudzbe='0')),
					('3', (select ArtikalId from [dbo].[Artikal] where ArtikalIme='Sladoled Vanilija'), (select NarudzbaZaKaficId from [dbo].NarudzbaZaKafic where StatusNarudzbe='0')),
					('15', (select ArtikalId from [dbo].[Artikal] where ArtikalIme='Fanta'), (select NarudzbaZaKaficId from [dbo].NarudzbaZaKafic where StatusNarudzbe='0')),
					('15', (select ArtikalId from [dbo].[Artikal] where ArtikalIme='Sprite'), (select NarudzbaZaKaficId from [dbo].NarudzbaZaKafic where StatusNarudzbe='0')),
					('13', (select ArtikalId from [dbo].[Artikal] where ArtikalIme='Jamnica Sensation'), (select NarudzbaZaKaficId from [dbo].NarudzbaZaKafic where StatusNarudzbe='0')),
					('17', (select ArtikalId from [dbo].[Artikal] where ArtikalIme='Jamnica'), (select NarudzbaZaKaficId from [dbo].NarudzbaZaKafic where StatusNarudzbe='0'))
go
